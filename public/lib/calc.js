/**
 * public/lib/calc.js
 * Client-side copy of the calculation engine.
 * Identical pure functions as lib/calc.js but using ES module syntax
 * for use in the browser without a build step.
 *
 ...
 */
export function computePot(chips, chipValues) {
  return (
 ...
 */
export function computeRake(potNPR, rakePercent) {
 ...
 */
export function computePayout(chips, chipValues, rakeOwed) {
 ...
 */
export function computePlayerRakeOwed(rounds, playerName) {
  return rounds
 ...
 */
export function computeTotalRake(rounds) {
